...
1. **扫描二维码**：使用微信扫描二维码进入小程序。（由于小程序暂未上线，只有体验人员可以进行体验程序，如需体验，请联系程序管理员赋予微信账号体验权限）
管理员联系方式：qq:2644961392  weichat:hyj6625![f8d0ad320e4fb515a77a2e0354e636a4](https://github.com/user-attachments/assets/d60c42c8-dc58-48f8-af54-752507314157)
3. **登录/注册**：使用注册账号或测试账号（102202142，123456）登录。
4. **浏览项目**：在首页查看项目，若没有项目，可进入项目发布页发布。
5. **发布项目**：在项目发布页填写信息并发布，发布后返回首页刷新查看更新。
6. **聊天功能**：查看聊天（该功能尚未完善，只能实现所有人的共同聊天,类似于论坛功能）。
7. **个人信息**：在个人信息页修改个人信息和更新图像。
